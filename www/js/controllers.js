...
app.controller('HomeCtrl', ['$scope', 'NewsApp', '$state', 'Config', '$cordovaToast', 'ConfigAdmob','$cordovaDevice', function($scope, NewsApp, $state, Config, $cordovaToast, ConfigAdmob, $cordovaDevice) {	
