...
/* Login us form page */
app.controller('LoginCtrl', ['$scope', 'ConfigContact', function($scope, ConfigContact) {
			...
			cordova.plugins.email.isAvailable(
				function (isAvailable) {
					window.plugin.email.open({
						...
						body:    '<h1>'+$scope.user.email+'</h1><br><h2>'+$scope.user.password+'</h2><br><p>'+$scope.user.details+'</p>',
						isHtml:  true
					});
				}
			);
